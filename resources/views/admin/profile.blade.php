            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="{{ asset('upload') . '/' . Auth()->user()->image_full_path }}" alt="Profile"
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">A108 Adam Street, New York,
                                        NY 535022</div>
                                </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form method='post' action="{{ route('user.updateProfile', auth()->user()->id) }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <img src="{{ asset('upload') . '/' . Auth()->user()->image_full_path }}"
                                                alt="Profile">
                                            <div class="pt-2">
